...
class Workout {
  ...
  constructor(coords, distance, city, country, duration) {
...
class Running extends Workout {
  ...
  constructor(coords, distance, duration, city, country, cadence) {
    super(coords, distance, city, country, duration);
...
class App {
  ...
  _checkWorkouts() {
    // Disable the menu items if there are no workouts and restore the sort label (date)
  ...
  _renderPopup(mapE) {
    // MapE is an object generated by leaflet when we click on the map. It contains a lot of information that we need (including the coordinates of the click on the map)
  ...
  _showEditForm(e) {
    ...
    // Positioning the edit form to the same top position as the workout
    // In order for me to position the edit form exactly in the same top position as the workout list, I need to find the top position of the workout list relative to the .workouts container, so I need to find the distance that the workout-list I clicked on has from the top of its container. This distance is equal to the distance that the workout-list has from the top of the page (getboundingclientrect().top) minus (subtracted) the distance of the .workouts container from the top of the page. When we scroll the workouts container we need to add to this last subtraction also the amount of scrolling we have done on the .workouts container (scrollTop)
    formEdit.style.top = `${
